...
<html>
	...
	<body>
		<a href="#list-reportLayout" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-reportLayout" class="content scaffold-list" role="main">
			...
			<table>
				...
				<tbody>
				<g:each in="${reportLayoutInstanceList}" status="i" var="reportLayoutInstance">
			...
			<div class="pagination">
				<g:paginate total="${reportLayoutInstanceTotal}" />
			</div>
		</div>
	</body>
</html>
