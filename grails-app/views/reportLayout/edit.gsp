...
<html>
	...
	<body>
		<a href="#edit-reportLayout" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-reportLayout" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${reportLayoutInstance?.version}" />
				<fieldset class="form">
