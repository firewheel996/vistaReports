			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="answerFormat" title="${message(code: 'question.answerFormat.label', default: 'Answer Format')}" />
				...
				<g:each in="${questionInstanceList}" status="i" var="questionInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: questionInstance, field: "answerFormat")}</td>
